# -*- coding: utf-8 -*-
"""Confusables corpus for pl -- temporal-looking tokens that must NOT bind.
...
_SPAN_ELSEWHERE = [
    ('mały szczegół za 3 dni', 'szczegół'),
    ('milion powodów za 2 tygodnie', 'milion'),
]
