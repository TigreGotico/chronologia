"""Polish fuzzy month parts ("early/mid/late March").
...
@pytest.mark.parametrize("text,s,e", [
    ('początek marca', AstroDate(2017, 3, 1, 0, 0), AstroDate(2017, 3, 11, 8, 0)),
    ('połowa marca', AstroDate(2017, 3, 11, 8, 0), AstroDate(2017, 3, 21, 16, 0)),
