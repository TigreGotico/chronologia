# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (pl).

The "ostatni" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('ostatni poniedziałek maja 2017', 2017, 5, 0), ('ostatni piątek grudnia 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('pierwszy poniedziałek maja 2017') == AstroDate(2017, 5, 1)
