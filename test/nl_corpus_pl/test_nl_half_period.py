# -*- coding: utf-8 -*-
"""Calendar halves (pl): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "pierwsza" bind NUM=1.
...
_CASES = [
    ('pierwsza połowa 2020', 2020, 1, 1, 2020, 7, 1),
    ('druga połowa 2020', 2020, 7, 1, 2021, 1, 1),
]
