"""A half-year phrase that NAMES its year with the Polish year word.

Spelling the year word out ("pierwsza połowa roku 2020") selects exactly
the same six months as the bare-year wording ("pierwsza połowa 2020") --
...
@pytest.mark.parametrize("text,s,e", [
    ('pierwsza połowa roku 2020', (2020, 1, 1), (2020, 7, 1)),
    ('druga połowa roku 2020', (2020, 7, 1), (2021, 1, 1)),
])
...
@pytest.mark.parametrize("text", [
    'pierwsza połowa roku 2020',
    'druga połowa roku 2020',
])
...
def test_matches_the_bare_year_wording():
    ...
    assert start_end('pierwsza połowa roku 2020') == start_end('pierwsza połowa 2020')
