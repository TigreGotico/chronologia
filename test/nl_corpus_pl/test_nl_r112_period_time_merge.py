...
Root cause (see chronologia/extract/matcher.py, HOUR slot): ``pl`` is an
...
"10.42" HH.MM decimal, so ``clock_time`` never matched and "w piątek o 10."
stayed a date-only span with "o 10." stranded in the remainder -- while
plain "w piątek o 10" (no trailing period) merged correctly.
"""
...
def test_sentence_final_period_merges():
    assert start("Spotkanie jest w piątek o 10.") == ad(_FRIDAY_10)
