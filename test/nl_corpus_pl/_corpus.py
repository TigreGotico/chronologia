"""Shared helpers for the Polish natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "pl", anchor)``: feed a sentence a Polish speaker
...
Polish is a heavily inflected West-Slavic language: the offset unit noun
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "pl", anchor)
