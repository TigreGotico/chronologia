# -*- coding: utf-8 -*-
"""early/mid/late composed with the Galician decade construction (gl):
"a principios/a mediados/a finais dos anos NNNN" and the word-form decade
"os anos noventa" -- same snap-to-year thirds convention as
...
_CASES = [
    ('a principios dos anos 2000', DECADE_2000S, 'early'),
    ('a mediados dos anos 2000', DECADE_2000S, 'mid'),
    ('a finais dos anos 2000', DECADE_2000S, 'late'),
    ('a principios dos anos noventa', DECADE_90S, 'early'),
    ('a mediados dos anos noventa', DECADE_90S, 'mid'),
    ('a finais dos anos noventa', DECADE_90S, 'late'),
]
