"""Vernacular Roman-calendar anchors (gl) -- Kalends, Nones, Ides.

The three monthly anchors read as gl's own words and compose for free
...
@pytest.mark.parametrize("text,iso", [
    ('os idos de marzo', '2017-3-15'),
    ('as calendas de abril', '2017-4-1'),
    ('as nonas de xullo', '2017-7-7'),
    ('as nonas de xaneiro', '2017-1-5'),
    ('os idos de xaneiro', '2017-1-13'),
    ('as calendas de xaneiro', '2017-1-1'),
])
...
@pytest.mark.parametrize("text,iso", [
    ('3 días antes das calendas de abril', '2017-3-29'),
    ('unha semana antes dos idos de marzo', '2017-3-8'),
    ('2 días despois das calendas de abril', '2017-4-3'),
])
