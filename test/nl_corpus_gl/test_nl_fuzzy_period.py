"""Fuzzy sub-spans (gl): early/mid/late = first/middle/last arithmetic
...
_CASES = [('inicios de mes', 'M', 'early'), ('mediados de mes', 'M', 'mid'), ('finais de mes', 'M', 'late'), ('inicios de ano', 'Y', 'early'), ('mediados de ano', 'Y', 'mid'), ('finais de ano', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['o principio', 'madrugador'])
