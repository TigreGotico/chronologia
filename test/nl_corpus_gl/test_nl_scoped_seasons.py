...
@pytest.mark.parametrize("text,n", [("o primeira semana de xuño", 1), ("o segunda semana de xuño", 2), ("o terceira semana de xuño", 3)])
...
def test_last_day_of_month():
    assert start("o última día de xuño") \
        == AstroDate(2017, 6, 30)
...
@pytest.mark.parametrize("text,y,m", [
    ("verán de 1969", 1969, 6),
    ("inverno de 1970", 1970, 12),
