# -*- coding: utf-8 -*-
"""Fuzzy sub-spans (cs): early/mid/late = first/middle/last arithmetic third of
...
_CASES = [
    ("začátek měsíce", "M", "early"),
    ("polovina měsíce", "M", "mid"),
    ("konec měsíce", "M", "late"),
    ("začátek roku", "Y", "early"),
    ("polovina roku", "Y", "mid"),
    ("konec roku", "Y", "late"),
    ("začátek týdne", "W", "early"),
    ("konec týdne", "W", "late"),
]
...
@pytest.mark.parametrize("text", ["začátek", "schůzku"])
