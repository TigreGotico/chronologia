# -*- coding: utf-8 -*-
"""Calendar halves (cs): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "první" bind NUM=1.
...
_CASES = [
    ('první polovina 2020', 2020, 1, 1, 2020, 7, 1),
    ('druhá polovina 2020', 2020, 7, 1, 2021, 1, 1),
]
