# -*- coding: utf-8 -*-
"""ISO-8601 weeks (cs), Monday-based by the standard, independent of the civil
...
_CASES = [
    ...
    ('týden 26', 2017, 26),
    ('týden 52', 2017, 52),
    ('týden 32 2026', 2026, 32),
    ('týden 10 1999', 1999, 10),
    ('týden 40 2024', 2024, 40),
    ('týden 7 2030', 2030, 7),
]
...
@pytest.mark.parametrize("text", ['týden 0', 'týden 60', 'týden 99 2020'])
