# -*- coding: utf-8 -*-
"""Czech time-of-day dayparts (CLDR 47 day-period bands, locale cs).
...
``daypart_*_cs.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ...
    ('zítra odpoledne', AstroDate(2017, 6, 28, 12, 0), AstroDate(2017, 6, 28, 18, 0)),
