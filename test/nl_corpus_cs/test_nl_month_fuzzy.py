"""Czech fuzzy month parts ("early/mid/late March").
...
@pytest.mark.parametrize("text,s,e", [
    ('začátek března', AstroDate(2017, 3, 1, 0, 0), AstroDate(2017, 3, 11, 8, 0)),
    ('polovina března', AstroDate(2017, 3, 11, 8, 0), AstroDate(2017, 3, 21, 16, 0)),
    ('konec března', AstroDate(2017, 3, 21, 16, 0), AstroDate(2017, 4, 1, 0, 0)),
])
