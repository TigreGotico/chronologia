# -*- coding: utf-8 -*-
"""Fuzzy sub-spans (hr): early/mid/late = first/middle/last arithmetic third of
...
_CASES = [
    ("početak mjeseca", "M", "early"),
    ("sredina mjeseca", "M", "mid"),
    ("kraj mjeseca", "M", "late"),
    ("početak godine", "Y", "early"),
    ("sredina godine", "Y", "mid"),
    ("kraj godine", "Y", "late"),
    ("početak tjedna", "W", "early"),
    ("kraj tjedna", "W", "late"),
]
...
@pytest.mark.parametrize("text", ["početak", "sastanak"])
