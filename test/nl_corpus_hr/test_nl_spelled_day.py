...
Croatian puts the day in the genitive of the ordinal, in either the short
(-og) or the long (-oga) variant, beside a genitive month name; the tens
element of a compound day stays a bare cardinal, optionally joined by "i".
...
@pytest.mark.parametrize("text,y,m,d", [
    ('trećeg prosinca', 2017, 12, 3),
    ('trećega prosinca', 2017, 12, 3),
    ('prvog svibnja', 2018, 5, 1),
    ('dvadesetog prosinca', 2017, 12, 20),
])
...
@pytest.mark.parametrize("text,y,m,d", [
    ('dvadeset trećeg prosinca', 2017, 12, 23),
    ('dvadeset i trećeg prosinca', 2017, 12, 23),
    ('trideset prvog prosinca', 2017, 12, 31),
])
...
@pytest.mark.parametrize("text,y,m,d", [
    ('3. prosinca', 2017, 12, 3),
    ('23. prosinca', 2017, 12, 23),
])
