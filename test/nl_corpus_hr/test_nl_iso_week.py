# -*- coding: utf-8 -*-
"""ISO-8601 weeks (hr), Monday-based by the standard, independent of the civil
...
_CASES = [
    ...
    ('tjedan 26', 2017, 26),
    ('tjedan 52', 2017, 52),
    ('tjedan 32 2026', 2026, 32),
    ('tjedan 10 1999', 1999, 10),
    ('tjedan 40 2024', 2024, 40),
    ('tjedan 7 2030', 2030, 7),
]
...
@pytest.mark.parametrize("text", ['tjedan 0', 'tjedan 60', 'tjedan 99 2020'])
