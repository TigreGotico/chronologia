# -*- coding: utf-8 -*-
"""Croatian time-of-day dayparts (CLDR 47 day-period bands, locale hr).
...
``daypart_*_hr.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ('danas ujutro', AstroDate(2017, 6, 27, 4, 0), AstroDate(2017, 6, 27, 12, 0)),
