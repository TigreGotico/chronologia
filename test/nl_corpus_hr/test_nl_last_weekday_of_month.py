# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (hr).

The "posljednji" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('posljednji ponedjeljak svibnja 2017', 2017, 5, 0), ('zadnji petak prosinca 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('prvi ponedjeljak svibnja 2017') == AstroDate(2017, 5, 1)
