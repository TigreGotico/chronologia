"""Shared helpers for the Croatian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "hr", anchor)``: feed a sentence a Croatian speaker
...
Croatian is a heavily inflected South-Slavic language: the offset unit noun
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "hr", anchor)
