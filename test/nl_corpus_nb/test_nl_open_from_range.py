"""Open-ended "from <year>" ranges in Norwegian Bokmål.
...
def test_closed_from_to_range_is_unchanged():
    ...
    (start, end), rem = _span_rem("fra 2010 til 2020")
