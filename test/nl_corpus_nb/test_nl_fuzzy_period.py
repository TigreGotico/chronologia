"""Fuzzy sub-spans (nb): early/mid/late = first/middle/last arithmetic
...
_CASES = [('begynnelsen av måneden', 'M', 'early'), ('midten av måneden', 'M', 'mid'), ('slutten av måneden', 'M', 'late'), ('begynnelsen av året', 'Y', 'early'), ('slutten av året', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['begynnelsen', 'tidlig'])
