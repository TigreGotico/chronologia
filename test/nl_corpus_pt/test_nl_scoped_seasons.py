...
@pytest.mark.parametrize("text,n", [("o primeira semana de junho", 1), ("o terceira semana de junho", 3)])
...
def test_last_day_of_month():
    assert start("o última dia de junho") \
        == AstroDate(2017, 6, 30)
