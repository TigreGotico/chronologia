"""A half-year phrase that NAMES its year with the English year word.

Spelling the year word out ("the first half of the year 2020") selects
exactly the same six months as the bare-year wording ("the first half of
...
@pytest.mark.parametrize("text,s,e", [
    ('the first half of the year 2020', (2020, 1, 1), (2020, 7, 1)),
    ('the second half of the year 2020', (2020, 7, 1), (2021, 1, 1)),
])
...
def test_matches_the_bare_year_wording():
    ...
    assert start_end('the first half of the year 2020') == start_end('the first half of 2020')
