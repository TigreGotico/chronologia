"""Vernacular Roman-calendar anchors (ro) -- Kalends, Nones, Ides.

The three monthly anchors read as ro's own words and compose for free
...
@pytest.mark.parametrize("text,iso", [
    ('idele lui martie', '2017-3-15'),
    ('calendele lui aprilie', '2017-4-1'),
    ('nonele lui iulie', '2017-7-7'),
    ('nonele lui ianuarie', '2017-1-5'),
    ('idele lui ianuarie', '2017-1-13'),
    ('calendele lui ianuarie', '2017-1-1'),
])
...
@pytest.mark.parametrize("text,iso", [
    ('3 zile înainte de calendele lui aprilie', '2017-3-29'),
    ('o săptămână înainte de idele lui martie', '2017-3-8'),
    ('2 zile după calendele lui aprilie', '2017-4-3'),
])
