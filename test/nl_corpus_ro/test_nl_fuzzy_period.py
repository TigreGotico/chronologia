"""Fuzzy sub-spans (ro): early/mid/late = first/middle/last arithmetic
...
_CASES = [('început de lună', 'M', 'early'), ('mijloc de lună', 'M', 'mid'), ('sfârșit de lună', 'M', 'late'), ('început de an', 'Y', 'early'), ('mijloc de an', 'Y', 'mid'), ('sfârșit de an', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['începutul', 'devreme'])
