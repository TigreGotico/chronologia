# -*- coding: utf-8 -*-
"""da: the spaced day deictics CLDR gives as the standard surfaces.

Unicode CLDR 47 ``cldr-dates-full/main/da/dateFields.json`` spells the
day deictics of Danish with a space -- ``day.relative-type--2`` through
...
def test_bare_morgen_is_still_tomorrow():
    """Morgen carries no morning band in Danish; bare, it is the day word."""
    s = span("morgen")
