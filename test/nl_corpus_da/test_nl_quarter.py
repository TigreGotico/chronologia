"""Calendar quarters (da). Quarter N spans months [3N-2 .. 3N]; edges
hand-derived (anchor 2017-06-27, in Q2). Out-of-range is not a quarter."""
import pytest
from chronologia.astrodate import AstroDate
from ._corpus import start_end, parse

_CASES = [('Q3 2026', 2026, 7, 2026, 10), ('Q1 2020', 2020, 1, 2020, 4), ('Q2 2018', 2018, 4, 2018, 7), ('dette kvartal', 2017, 4, 2017, 7), ('næste kvartal', 2017, 7, 2017, 10), ('sidste kvartal', 2017, 1, 2017, 4)]
...
@pytest.mark.parametrize("text", ["Q5 2026", 'et almindeligt møde'])
