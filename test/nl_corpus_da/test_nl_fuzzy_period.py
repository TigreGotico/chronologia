"""Fuzzy sub-spans (da): early/mid/late = first/middle/last arithmetic
...
_CASES = [('begyndelsen af måneden', 'M', 'early'), ('midten af måneden', 'M', 'mid'), ('slutningen af måneden', 'M', 'late'), ('begyndelsen af året', 'Y', 'early'), ('slutningen af året', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['begyndelsen', 'tidligt'])
