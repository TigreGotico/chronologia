# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (da).

The "sidste" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('sidste mandag i maj 2017', 2017, 5, 0), ('sidste fredag i december 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('første mandag i maj 2017') == AstroDate(2017, 5, 1)
