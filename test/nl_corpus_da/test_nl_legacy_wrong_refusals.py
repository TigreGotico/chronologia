...
Danish has no reading for these, and the older ovos-date-parser produced a
...
LEGACY_INVENTED = [
    ('20', '2017-06-27T20:00'),  # a bare integer read as a clock
]

#: phrase -> the value Danish really does resolve, at the same anchor.
CONTROLS = [
    ('kl 20', '2017-06-27T20:00:00'),
]
