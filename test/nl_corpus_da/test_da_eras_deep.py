"""da: BC/AD (multi-word era vocabulary), deep time, named periods."""
import pytest
...
@pytest.mark.parametrize("text", ['jura', 'kridt', 'trias', 'devon', 'perm', 'paleozoikum', 'mesozoikum', 'holocæn', 'pleistocæn', 'kambrium', 'bronzealderen', 'jernalderen', 'under jura', 'under kridt'])
