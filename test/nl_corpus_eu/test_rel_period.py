...
CASES = [
    ('datorren astea', 1, 'week'),
    ('aurreko astea', -1, 'week'),
    ('aste honetako', 0, 'week'),
    ('datorren hilabetea', 1, 'month'),
    ('aurreko hilabetea', -1, 'month'),
    ('datorren urtea', 1, 'year'),
    ('aurreko urtea', -1, 'year'),
]
