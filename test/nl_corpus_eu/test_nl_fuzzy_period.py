"""Fuzzy sub-spans (eu): hasiera/erdi/amaiera (early/mid/late) of a parent
calendar period, marked by a postposed inessive noun (hilabete amaieran).
Parent edges hand-derived; the third is pure timedelta arithmetic."""
...
_CASES = [("hilabete hasieran", "M", "early"), ("hilabete erdian", "M", "mid"),
          ("hilabete amaieran", "M", "late"), ("urte hasieran", "Y", "early"),
          ("urte erdian", "Y", "mid"), ("urte amaieran", "Y", "late"),
          ("datorren hilabete hasieran", "NM", "early"),
          ("datorren hilabete amaieran", "NM", "late")]
...
@pytest.mark.parametrize("text", ["hasiera", "goiz"])
