...
Estonian has no reading for these, and the older ovos-date-parser produced a
...
LEGACY_INVENTED = [
    ('45. jaanuar', '2018-01-01'),  # a day that does not exist, clamped into range
]

#: phrase -> the value Estonian really does resolve, at the same anchor.
CONTROLS = [
    ('5. jaanuar', '2018-01-05T00:00:00'),
]
