...
@pytest.mark.parametrize("text,ymd", [
    ('la settimana del 20 luglio 2026', (2026, 7, 20)),
    ('la settimana di 20 luglio 2026', (2026, 7, 20)),
    ('la settimana del 15 gennaio 2026', (2026, 1, 15)),
    ('la settimana di 15 gennaio 2026', (2026, 1, 15)),
    ('la settimana del 10 dicembre 2026', (2026, 12, 10)),
    ('la settimana di 10 dicembre 2026', (2026, 12, 10)),
    ('la settimana del 5 marzo 2026', (2026, 3, 5)),
    ('la settimana di 5 marzo 2026', (2026, 3, 5)),
])
...
def test_bare_date_is_a_single_day(ymd):
    ...
    MN = {1: 'gennaio', 3: 'marzo', 7: 'luglio', 12: 'dicembre'}
