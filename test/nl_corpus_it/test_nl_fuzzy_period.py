"""Fuzzy sub-spans (it): early/mid/late = first/middle/last arithmetic
...
_CASES = [('inizio mese', 'M', 'early'), ('metà mese', 'M', 'mid'), ('fine mese', 'M', 'late'), ('inizio anno', 'Y', 'early'), ('metà anno', 'Y', 'mid'), ('fine anno', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['il principio', 'presto'])
