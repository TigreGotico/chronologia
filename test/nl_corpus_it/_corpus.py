"""Shared helpers for the Italian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "it", anchor)``: feed a sentence a Italian speaker
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "it", anchor)
