# -*- coding: utf-8 -*-
"""sv: aggressive "Nth <weekday> i <month> <year>" sweep.

Binds ORD + WEEKDAY + "i" + MONTH + YEAR into the nth-weekday-of-that-named-
month span. The gold day is computed by INDEPENDENT calendar arithmetic
...
Anchor Tuesday 2017-06-27; year-qualified so no prefer-future roll applies.
"""
import calendar
...
from ._corpus import start, parse, ad
...
def test_ordinal_weekday_of_month(text, gold):
