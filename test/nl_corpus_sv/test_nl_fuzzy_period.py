"""Fuzzy sub-spans (sv): early/mid/late = first/middle/last arithmetic
...
_CASES = [('början av månaden', 'M', 'early'), ('mitten av månaden', 'M', 'mid'), ('slutet av månaden', 'M', 'late'), ('början av året', 'Y', 'early'), ('slutet av året', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['början', 'tidigt'])
