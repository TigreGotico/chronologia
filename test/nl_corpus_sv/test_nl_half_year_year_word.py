"""A half-year phrase that NAMES its year with the Swedish year word.

Spelling the year word out ("första hälften av året 2020") selects exactly
the same six months as the bare-year wording ("första hälften av 2020") --
...
@pytest.mark.parametrize("text,s,e", [
    ('första hälften av året 2020', (2020, 1, 1), (2020, 7, 1)),
    ('andra hälften av året 2020', (2020, 7, 1), (2021, 1, 1)),
])
...
@pytest.mark.parametrize("text", [
    'första hälften av året 2020',
    'andra hälften av året 2020',
])
...
def test_matches_the_bare_year_wording():
    ...
    assert start_end('första hälften av året 2020') == start_end('första hälften av 2020')
