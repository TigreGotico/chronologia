# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (nl).

The "laatste" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('de laatste zaterdag van augustus 2019', 2019, 8, 5), ('de laatste maandag van mei 2017', 2017, 5, 0)]
...
def test_low_ordinal_regression():
    ...
    assert start('de eerste zaterdag van augustus 2019') == AstroDate(2019, 8, 3)
