"""Vernacular Roman-calendar anchors (nl) -- Kalends, Nones, Ides.

The three monthly anchors read as nl's own words and compose for free
...
@pytest.mark.parametrize("text,iso", [
    ('de Iden van maart', '2017-3-15'),
    ('de Kalenden van april', '2017-4-1'),
    ('de Nonen van juli', '2017-7-7'),
    ('de Nonen van januari', '2017-1-5'),
    ('de Iden van januari', '2017-1-13'),
    ('de Kalenden van januari', '2017-1-1'),
])
...
@pytest.mark.parametrize("text,iso", [
    ('3 dagen voor de Kalenden van april', '2017-3-29'),
    ('een week voor de Iden van maart', '2017-3-8'),
    ('2 dagen na de Kalenden van april', '2017-4-3'),
])
