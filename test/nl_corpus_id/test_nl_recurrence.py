...
# on with "setiap hari" (every day).  Both readings are genuine Indonesian, so
# both have to come out right: the collision is grammatical, not a typo.
_CLASSIFIER_CASES = [
    ('setiap hari senin', 'FREQ=WEEKLY;BYDAY=MO', ''),
    ('setiap hari selasa', 'FREQ=WEEKLY;BYDAY=TU', ''),
    ('setiap hari rabu', 'FREQ=WEEKLY;BYDAY=WE', ''),
    ('setiap hari kamis', 'FREQ=WEEKLY;BYDAY=TH', ''),
    ('setiap hari jumat', 'FREQ=WEEKLY;BYDAY=FR', ''),
    ('setiap hari sabtu', 'FREQ=WEEKLY;BYDAY=SA', ''),
    ('setiap hari ahad', 'FREQ=WEEKLY;BYDAY=SU', ''),
    ('setiap hari minggu', 'FREQ=WEEKLY;BYDAY=SU', ''),
    ('tiap hari jumat', 'FREQ=WEEKLY;BYDAY=FR', ''),
...
@pytest.mark.parametrize("text", ['hari senin', 'hari', 'hari hari', ''])
