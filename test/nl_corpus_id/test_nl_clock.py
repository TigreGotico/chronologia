...
# -- THE MALAY/INDONESIAN HALF TRAP: "setengah tiga" == 02:30 (half TOWARD
# three), NOT 03:30 -- the German-style toward-hour reading.  Cross-direction
# adversarial: assert 02:30 here, mirroring de "halb drei" == 02:30 and the
# OPPOSITE of English "half three" == 03:30.
# Source: KBBI "setengah jam" == 30 min; toward-hour clock corroborated across
# Indonesian usage.
@pytest.mark.parametrize("text,h,m", [
    ("setengah tiga", 2, 30),          # half toward three -- NOT 3:30
    ("pukul setengah tiga", 2, 30),
    ("setengah sembilan", 8, 30),      # half toward nine
    ("setengah lima", 4, 30),
])
