# -*- coding: utf-8 -*-
"""The "week of <date>" construction for id: widen a date to its week."""
...
@pytest.mark.parametrize("text,ymd", [
    ('minggu 20 juli 2026', (2026, 7, 20)),
    ('minggu 15 januari 2026', (2026, 1, 15)),
    ('minggu 10 desember 2026', (2026, 12, 10)),
    ('minggu 5 maret 2026', (2026, 3, 5)),
    ('minggu 4 juli 2026', (2026, 7, 4)),
    ('minggu 11 maret 2026', (2026, 3, 11)),
])
...
def test_bare_date_is_a_single_day(ymd):
    MN = {7: 'juli', 1: 'januari', 12: 'desember', 3: 'maret', 6: 'juni', 8: 'agustus'}
