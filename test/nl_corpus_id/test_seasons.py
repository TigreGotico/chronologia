...
KBBI defines each of these four as a season "terdapat di daerah
yang mempunyai empat musim" -- a season of the regions that have four
of them -- so the words name the temperate seasons even though Indonesia
itself has none.
...
still to begin and "lalu" the most recent one already over, so from a
...
CASES = [
    ...
    ('musim panas lalu', 2025, 6),
    ('musim semi depan', 2027, 3),
    ('musim gugur lalu', 2025, 9),
    ('musim dingin ini', 2026, 12),
    ('Saya ke Jepang musim gugur ini', 2026, 9),
