# -*- coding: utf-8 -*-
"""id: "pukul/jam <N> malam" is a midnight-crossing BAND, not a uniform +12.
...
00:00.  Evening "malam" opens at 18:00 (CLDR id night [18:00, 00:00),
transcribed in chronologia.dayparts); the small hours read as "malam"
colloquially.  Source: Wiktionary, malam.
...
@pytest.mark.parametrize("h", [1, 3, 11, 12])
def test_jam_malam_band(h):
    assert start(f"jam {h} malam") == clk(_night(h))
