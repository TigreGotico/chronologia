"""Fuzzy sub-spans (oc): early/mid/late = first/middle/last arithmetic
...
_CASES = [('començament de mes', 'M', 'early'), ('mitan de mes', 'M', 'mid'), ('fin de mes', 'M', 'late'), ("començament d'an", 'Y', 'early'), ("mitan d'an", 'Y', 'mid'), ("fin d'an", 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['lo començament', 'pòrta'])
