"""Shared helpers for the Occitan natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "oc", anchor)``: feed a sentence a Occitan speaker
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "oc", anchor)
