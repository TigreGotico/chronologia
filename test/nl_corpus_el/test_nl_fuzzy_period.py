"""Fuzzy sub-spans (el): αρχές/μέσα/τέλη (early/mid/late) of a parent calendar
period, framed with the genitive ("αρχές του μήνα"). Parent edges hand-derived;
the third is pure timedelta arithmetic."""
...
_CASES = [("αρχές του μήνα", "M", "early"), ("μέσα του μήνα", "M", "mid"),
          ("τέλη του μήνα", "M", "late"), ("αρχές του έτους", "Y", "early"),
          ("μέσα του έτους", "Y", "mid"), ("τέλη του έτους", "Y", "late")]
...
@pytest.mark.parametrize("text", ["αρχή", "νωρίς"])
