# -*- coding: utf-8 -*-
"""Durations in an: extract_duration -> timedelta."""
...
_CASES = [
    ...
    ('un diyas', timedelta(days=1)),
    ('2 diyas', timedelta(days=2)),
    ('3 semanas', timedelta(weeks=3)),
    ('90 minutos', timedelta(minutes=90)),
    ('meya hora', timedelta(minutes=30)),
    ('un quarto de hora', timedelta(minutes=15)),
    ('2 diyas 4 hora', timedelta(days=2, hours=4)),
...
@pytest.mark.parametrize("text", ['2 meses', 'cosa aquí'])
