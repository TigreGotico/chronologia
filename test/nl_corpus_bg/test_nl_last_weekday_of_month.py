# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (bg).

The "последен" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('последният понеделник на май 2017', 2017, 5, 0), ('последният петък на декември 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('втори понеделник на май 2017') == AstroDate(2017, 5, 8)
