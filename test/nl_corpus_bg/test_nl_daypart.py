# -*- coding: utf-8 -*-
"""Bulgarian time-of-day dayparts (CLDR 47 day-period bands, locale bg).
...
``daypart_*_bg.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ('днес сутрин', AstroDate(2017, 6, 27, 4, 0), AstroDate(2017, 6, 27, 14, 0)),
    ('вчера вечер', AstroDate(2017, 6, 26, 18, 0), AstroDate(2017, 6, 26, 22, 0)),
    ('утре следобед', AstroDate(2017, 6, 28, 14, 0), AstroDate(2017, 6, 28, 18, 0)),
    ('нощем', AstroDate(2017, 6, 27, 22, 0), AstroDate(2017, 6, 28, 4, 0)),
]
