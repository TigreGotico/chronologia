# -*- coding: utf-8 -*-
"""Calendar halves (bg): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "първата" bind NUM=1.
...
_CASES = [
    ('първата половина на 2020', 2020, 1, 1, 2020, 7, 1),
    ('втората половина на 2020', 2020, 7, 1, 2021, 1, 1),
]
