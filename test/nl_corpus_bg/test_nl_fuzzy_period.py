# -*- coding: utf-8 -*-
"""Fuzzy sub-spans (bg): early/mid/late = first/middle/last arithmetic third of
...
_CASES = [
    ("началото на месеца", "M", "early"),
    ("средата на месеца", "M", "mid"),
    ("края на месеца", "M", "late"),
    ("началото на годината", "Y", "early"),
    ("средата на годината", "Y", "mid"),
    ("края на годината", "Y", "late"),
    ("началото на седмицата", "W", "early"),
    ("края на седмицата", "W", "late"),
]
...
@pytest.mark.parametrize("text", ["началото", "срещата"])
