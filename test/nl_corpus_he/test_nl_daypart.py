# -*- coding: utf-8 -*-
"""Hebrew time-of-day dayparts (CLDR 47 day-period bands, locale he).
...
``daypart_*_he.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ('היום בבוקר', AstroDate(2017, 6, 27, 6, 0), AstroDate(2017, 6, 27, 12, 0)),
    ('אתמול בערב', AstroDate(2017, 6, 26, 18, 0), AstroDate(2017, 6, 26, 22, 0)),
    ('מחר בבוקר', AstroDate(2017, 6, 28, 6, 0), AstroDate(2017, 6, 28, 12, 0)),
    ('בלילה', AstroDate(2017, 6, 27, 22, 0), AstroDate(2017, 6, 28, 6, 0)),
]
