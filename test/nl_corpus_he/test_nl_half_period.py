# -*- coding: utf-8 -*-
"""Calendar halves (he): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "הראשונה" bind NUM=1.
...
_CASES = [
    ('המחצית הראשונה של 2020', 2020, 1, 1, 2020, 7, 1),
    ('המחצית השנייה של 2020', 2020, 7, 1, 2021, 1, 1),
]
