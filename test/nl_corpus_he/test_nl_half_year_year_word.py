"""A half-year phrase that NAMES its year with the Hebrew year word.

Spelling the year word out ("המחצית הראשונה של שנת 2020") selects exactly
the same six months as the bare-year wording ("המחצית הראשונה של 2020") --
...
@pytest.mark.parametrize("text,s,e", [
    ('המחצית הראשונה של שנת 2020', (2020, 1, 1), (2020, 7, 1)),
    ('המחצית השנייה של שנת 2020', (2020, 7, 1), (2021, 1, 1)),
])
...
@pytest.mark.parametrize("text", [
    'המחצית הראשונה של שנת 2020',
    'המחצית השנייה של שנת 2020',
])
...
def test_matches_the_bare_year_wording():
    ...
    assert start_end('המחצית הראשונה של שנת 2020') == start_end('המחצית הראשונה של 2020')
