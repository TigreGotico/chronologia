# -*- coding: utf-8 -*-
"""Fuzzy sub-spans (sl): early/mid/late = first/middle/last arithmetic third of
...
_CASES = [
    ("začetek meseca", "M", "early"),
    ("sredina meseca", "M", "mid"),
    ("konec meseca", "M", "late"),
    ("začetek leta", "Y", "early"),
    ("sredina leta", "Y", "mid"),
    ("konec leta", "Y", "late"),
    ("začetek tedna", "W", "early"),
    ("konec tedna", "W", "late"),
]
...
@pytest.mark.parametrize("text", ["začetek", "sestanek"])
