...
Slovene puts the day in the genitive of the ordinal beside a genitive month
name (Fran, ZRC SAZU), and writes a compound day as one word with the unit
first -- "triindvajsetega" is literally three-and-twentieth.
...
@pytest.mark.parametrize("text,y,m,d", [
    ('tretjega decembra', 2017, 12, 3),
    ('prvega januarja', 2018, 1, 1),
    ('desetega novembra', 2017, 11, 10),
    ('dvajsetega decembra', 2017, 12, 20),
])
...
@pytest.mark.parametrize("text,y,m,d", [
    ('triindvajsetega decembra', 2017, 12, 23),
    ('enaintridesetega decembra', 2017, 12, 31),
])
