# -*- coding: utf-8 -*-
"""ISO-8601 weeks (sl), Monday-based by the standard, independent of the civil
...
_CASES = [
    ...
    ('teden 26', 2017, 26),
    ('teden 52', 2017, 52),
    ('teden 32 2026', 2026, 32),
    ('teden 10 1999', 1999, 10),
    ('teden 40 2024', 2024, 40),
    ('teden 7 2030', 2030, 7),
]
...
@pytest.mark.parametrize("text", ['teden 0', 'teden 60', 'teden 99 2020'])
