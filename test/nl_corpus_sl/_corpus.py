"""Shared helpers for the Slovenian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "sl", anchor)``: feed a sentence a Slovenian speaker
...
Slovenian is a heavily inflected South-Slavic language: the offset unit noun
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "sl", anchor)
