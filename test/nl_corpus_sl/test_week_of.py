# -*- coding: utf-8 -*-
"""The "week of <date>" construction for sl: widen a date to its week."""
...
@pytest.mark.parametrize("text,ymd", [
    ('teden od 20 julija 2026', (2026, 7, 20)),
    ('teden od 15 januarja 2026', (2026, 1, 15)),
    ('teden od 10 decembra 2026', (2026, 12, 10)),
    ('teden od 5 marca 2026', (2026, 3, 5)),
    ('teden od 4 julija 2026', (2026, 7, 4)),
    ('teden od 11 marca 2026', (2026, 3, 11)),
])
...
def test_bare_date_is_a_single_day(ymd):
    MN = {7: 'julija', 1: 'januarja', 12: 'decembra', 3: 'marca', 6: 'junija', 8: 'avgusta'}
