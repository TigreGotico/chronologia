"""Slovenian fuzzy month parts ("early/mid/late March").
...
@pytest.mark.parametrize("text,s,e", [
    ('začetek marca', AstroDate(2017, 3, 1, 0, 0), AstroDate(2017, 3, 11, 8, 0)),
    ('sredina marca', AstroDate(2017, 3, 11, 8, 0), AstroDate(2017, 3, 21, 16, 0)),
    ('konec marca', AstroDate(2017, 3, 21, 16, 0), AstroDate(2017, 4, 1, 0, 0)),
])
