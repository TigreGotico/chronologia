# -*- coding: utf-8 -*-
"""Calendar quarters (sl). Quarter N spans months [3N-2 .. 3N]; anchor
2017-06-27 sits in Q2. Digit and Q-forms fold to the number; ordinal-WORD
forms ("tretji kvartal") are unsupported because the sl number model does not fold
...
_CASES = [
    ...
    ('naslednji kvartal', 2017, 7, 2017, 10),
    ('ta kvartal', 2017, 4, 2017, 7),
...
@pytest.mark.parametrize("text", ['Q5 2026', 'sestanek'])
