"""Month-thirds for a *named* month (fi): "maaliskuun alku/puoliväli/loppu"
...
strand the postposed third-marker (alku/puoliväli/loppu).

Uralic word order is genitive MONTH-first, marker postposed
(maaliskuun + alku/puoliväli/loppu), unlike the pre-posed Romance/Germanic
...
_CASES = [("maaliskuun alku", "early"), ("maaliskuun puoliväli", "mid"),
          ("maaliskuun loppu", "late")]
...
def test_plain_month_regression():
    """Plain "maaliskuu" (no third-marker) stays the WHOLE month."""
    s = span("maaliskuu", A)
