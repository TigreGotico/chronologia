# -*- coding: utf-8 -*-
"""Slovak time-of-day dayparts (CLDR 47 day-period bands, locale sk).
...
``daypart_*_sk.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ('dnes ráno', AstroDate(2017, 6, 27, 4, 0), AstroDate(2017, 6, 27, 12, 0)),
    ('včera večer', AstroDate(2017, 6, 26, 18, 0), AstroDate(2017, 6, 26, 22, 0)),
    ('zajtra popoludní', AstroDate(2017, 6, 28, 12, 0), AstroDate(2017, 6, 28, 18, 0)),
    ('ráno', AstroDate(2017, 6, 27, 4, 0), AstroDate(2017, 6, 27, 12, 0)),
]
