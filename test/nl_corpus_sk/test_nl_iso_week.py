# -*- coding: utf-8 -*-
"""ISO-8601 weeks (sk), Monday-based by the standard, independent of the civil
...
_CASES = [
    ...
    ('týždeň 26', 2017, 26),
    ('týždeň 52', 2017, 52),
    ('týždeň 32 2026', 2026, 32),
    ('týždeň 10 1999', 1999, 10),
    ('týždeň 40 2024', 2024, 40),
    ('týždeň 7 2030', 2030, 7),
]
...
@pytest.mark.parametrize("text", ['týždeň 0', 'týždeň 60', 'týždeň 99 2020'])
