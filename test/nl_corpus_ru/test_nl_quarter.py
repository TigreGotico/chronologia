# -*- coding: utf-8 -*-
"""Calendar quarters (ru). Quarter N spans months [3N-2 .. 3N]; anchor
2017-06-27 sits in Q2. Digit and Q-forms fold to the number; ordinal-WORD
forms ("третий квартал") are unsupported because the ru number model does not fold
...
_CASES = [
    ...
    ('3 квартал 2026', 2026, 7, 2026, 10),
    ('1 квартал 2020', 2020, 1, 2020, 4),
    ('2 квартал 2018', 2018, 4, 2018, 7),
    ('4 квартал 2019', 2019, 10, 2020, 1),
    ('следующий квартал', 2017, 7, 2017, 10),
    ('этот квартал', 2017, 4, 2017, 7),
...
@pytest.mark.parametrize("text", ['Q5 2026', 'встречу'])
...
@pytest.mark.xfail(reason="ordinal-word quarter unsupported: ru number model "
                          "does not fold ordinal words to a numeric ORD",
                   strict=True)
def test_ordinal_word_quarter():
    s, e = start_end("третий квартал 2026")
