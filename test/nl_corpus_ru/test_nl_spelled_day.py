...
Russian puts the day in the genitive of the ordinal beside a genitive month
name (Gramota.ru), and inflects only the last element of a compound day --
the tens stays a bare cardinal.
...
@pytest.mark.parametrize("text,y,m,d", [
    ('третьего декабря', 2017, 12, 3),
    ('первого мая', 2018, 5, 1),
    ('десятого ноября', 2017, 11, 10),
    ('двадцатого декабря', 2017, 12, 20),
])
...
@pytest.mark.parametrize("text,y,m,d", [
    ('двадцать третьего декабря', 2017, 12, 23),
    ('тридцать первого декабря', 2017, 12, 31),
])
