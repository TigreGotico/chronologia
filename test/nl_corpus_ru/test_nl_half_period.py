# -*- coding: utf-8 -*-
"""Calendar halves (ru): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "первая" bind NUM=1.
...
_CASES = [
    ('первая половина 2020', 2020, 1, 1, 2020, 7, 1),
    ('вторая половина 2020', 2020, 7, 1, 2021, 1, 1),
]
