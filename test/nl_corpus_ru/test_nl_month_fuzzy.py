"""Russian fuzzy month parts ("early/mid/late March").
...
@pytest.mark.parametrize("text,s,e", [
    ('начало марта', AstroDate(2017, 3, 1, 0, 0), AstroDate(2017, 3, 11, 8, 0)),
    ('середина марта', AstroDate(2017, 3, 11, 8, 0), AstroDate(2017, 3, 21, 16, 0)),
    ('конец марта', AstroDate(2017, 3, 21, 16, 0), AstroDate(2017, 4, 1, 0, 0)),
])
