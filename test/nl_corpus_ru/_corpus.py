"""Shared helpers for the Russian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "ru", anchor)``: feed a sentence a Russian speaker
...
Russian is a heavily inflected East-Slavic language: the offset unit noun
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "ru", anchor)
