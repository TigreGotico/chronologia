# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (ru).

The "последний" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('последний понедельник мая 2017', 2017, 5, 0), ('последняя суббота августа 2019', 2019, 8, 5)]
...
def test_low_ordinal_regression():
    ...
    assert start('первый понедельник мая 2017') == AstroDate(2017, 5, 1)
