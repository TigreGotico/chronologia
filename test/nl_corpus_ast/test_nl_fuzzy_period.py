"""Fuzzy sub-spans (ast): early/mid/late = first/middle/last arithmetic
...
_CASES = [('entamu de mes', 'M', 'early'), ('metá de mes', 'M', 'mid'), ('fin de mes', 'M', 'late'), ("entamu d'añu", 'Y', 'early'), ("metá d'añu", 'Y', 'mid'), ("fin d'añu", 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['el entamu', 'ceo'])
