"""Shared helpers for the Asturian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "ast", anchor)``: feed a sentence a Asturian speaker
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "ast", anchor)
