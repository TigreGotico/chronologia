# -*- coding: utf-8 -*-
"""Timezone-qualified clocks (fa): a trailing UTC/GMT (+ fixed offset) makes
the clock span aware.  Named-city zones out of scope.  Wall time obeys
...
_CASES = [(t, _aw(y, mo, d, h, mi, off)) for (t, y, mo, d, h, mi, off) in [
    ...
    ('15:00 utc+3:30', 2017, 6, 27, 15, 0, 210),
]]
