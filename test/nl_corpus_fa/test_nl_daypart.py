# -*- coding: utf-8 -*-
"""Persian time-of-day dayparts (CLDR 47 day-period bands, locale fa).
...
``daypart_*_fa.voc`` vocabulary. Anchor: Tuesday 2017-06-27 13:04.
"""
...
_BANDS = [
    ('امروز صبح', AstroDate(2017, 6, 27, 1, 0), AstroDate(2017, 6, 27, 12, 0)),
    ('دیروز شب', AstroDate(2017, 6, 26, 19, 0), AstroDate(2017, 6, 27, 1, 0)),
    ('فردا بعدازظهر', AstroDate(2017, 6, 28, 12, 0), AstroDate(2017, 6, 28, 19, 0)),
    ('عصر', AstroDate(2017, 6, 27, 12, 0), AstroDate(2017, 6, 27, 19, 0)),
]
