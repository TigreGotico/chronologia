"""Fuzzy sub-spans (es): early/mid/late = first/middle/last arithmetic
...
_CASES = [('principios de mes', 'M', 'early'), ('mediados de mes', 'M', 'mid'), ('finales de mes', 'M', 'late'), ('principios del año', 'Y', 'early'), ('mediados del año', 'Y', 'mid'), ('finales del año', 'Y', 'late'), ('principios de la semana que viene', 'NW', 'early'), ('finales de la semana que viene', 'NW', 'late'), ('comienzos de mes', 'M', 'early'), ('mediados del mes', 'M', 'mid')]
...
@pytest.mark.parametrize("text", ['el principio', 'madrugador'])
