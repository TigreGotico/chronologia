"""Calendar halves (es): "first/second half of <year>" splits the year
...
_CASES = [
    ('la primera mitad de 2020', 2020, 1, 1, 2020, 7, 1),
    ('la segunda mitad de 2020', 2020, 7, 1, 2021, 1, 1),
    ('la primera mitad del siglo', 2000, 1, 1, 2050, 1, 1),
    ('la segunda mitad del milenio', 2500, 1, 1, 3000, 1, 1),
]
