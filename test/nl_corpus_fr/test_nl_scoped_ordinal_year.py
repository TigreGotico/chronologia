# -*- coding: utf-8 -*-
"""An explicit trailing year reached through the French "de" connector must
...
def test_scoped_ordinal_binds_trailing_connector_year():
    ...
    assert start_end('le deuxième mardi de novembre 2019') == (
        AstroDate(2019, 11, 12), AstroDate(2019, 11, 13))
    assert parse('le deuxième mardi de novembre 2019')[1] == ''


def test_scoped_ordinal_no_year_stays_anchor_year():
    assert start_end('le deuxième mardi de novembre') == (
