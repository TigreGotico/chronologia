"""Shared helpers for the French natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "fr", anchor)``: feed a sentence a French speaker
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "fr", anchor)
