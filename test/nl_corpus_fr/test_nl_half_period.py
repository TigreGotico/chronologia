"""Calendar halves (fr): "first/second half of <year>" splits the year
...
_CASES = [
    ('la première moitié de 2020', 2020, 1, 1, 2020, 7, 1),
    ('la seconde moitié de 2020', 2020, 7, 1, 2021, 1, 1),
    ('la deuxième moitié de 2020', 2020, 7, 1, 2021, 1, 1),
]
