# -*- coding: utf-8 -*-
"""Calendar halves (de): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "erste" bind NUM=1.
...
_CASES = [
    ('erste Hälfte 2020', 2020, 1, 1, 2020, 7, 1),
    ('zweite Hälfte 2020', 2020, 7, 1, 2021, 1, 1),
]
