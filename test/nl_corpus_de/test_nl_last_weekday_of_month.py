# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (de).

The "letzte" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('der letzte Montag im Mai 2017', 2017, 5, 0), ('der letzte Freitag im Dezember 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('der erste Montag im Mai 2017') == AstroDate(2017, 5, 1)
