"""nn: clock times -- the CONTINENTAL-GERMANIC HALF TRAP centrepiece.
...
@pytest.mark.parametrize("text,h,mi", [('halv ni', 8, 30), ('halv sju', 6, 30), ('halv åtte', 7, 30), ('halv ti', 9, 30), ('halv elleve', 10, 30), ('halv tolv', 11, 30), ('halv to', 1, 30), ('halv tre', 2, 30), ('halv fire', 3, 30), ('halv fem', 4, 30), ('halv seks', 5, 30), ('halv middag', 11, 30), ('halv midnatt', 23, 30)])
def test_half_is_half_to(text, h, mi):
    assert start(text) == clk(h, mi)
    assert span(text).width == timedelta(minutes=1)


@pytest.mark.parametrize("text,h,mi", [('kvart over tre', 3, 15), ('kvart på ni', 8, 45), ('kvart over elleve', 11, 15), ('kvart på tolv', 11, 45), ('kvart over midnatt', 0, 15), ('kvart på midnatt', 23, 45), ('kvart over middag', 12, 15)])
