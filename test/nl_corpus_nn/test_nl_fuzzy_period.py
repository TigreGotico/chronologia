"""Fuzzy sub-spans (nn): early/mid/late = first/middle/last arithmetic
...
_CASES = [('byrjinga av månaden', 'M', 'early'), ('midten av månaden', 'M', 'mid'), ('slutten av månaden', 'M', 'late'), ('byrjinga av året', 'Y', 'early'), ('slutten av året', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['byrjinga', 'tidleg'])
