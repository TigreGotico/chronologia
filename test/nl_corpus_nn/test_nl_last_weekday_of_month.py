# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (nn).

The "siste" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('siste måndag i mai 2017', 2017, 5, 0), ('siste fredag i desember 2020', 2020, 12, 4)]
...
def test_low_ordinal_regression():
    ...
    assert start('første måndag i mai 2017') == AstroDate(2017, 5, 1)
