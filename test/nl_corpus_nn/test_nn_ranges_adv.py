"""nn: localized ranges and adversarial cases."""
...
@pytest.mark.parametrize("text,s,e", [('frå 5. juni til 12. juni', (2018, 6, 5), (2018, 6, 13)), ('5. juni til 12. juni', (2018, 6, 5), (2018, 6, 13)), ('frå mars 2020 til juni 2020', (2020, 3, 1), (2020, 7, 1)), ('frå 1990 til 2000', (1990, 1, 1), (2001, 1, 1)), ('mellom juni og august 2020', (2017, 6, 1), (2020, 9, 1))])
def test_range(text, s, e):
    assert start_end(text) == (AstroDate(*s), AstroDate(*e))


@pytest.mark.parametrize("text", ['elles', 'i orden', 'gå heim no', 'god morgon alle'])
...
@pytest.mark.parametrize("text", ['frå', 'til', 'mellom'])
