"""nn: BC/AD (multi-word era vocabulary), deep time, named periods."""
import pytest
...
@pytest.mark.parametrize("text,approx_year", [('for 66 millionar år sidan', -65998050), ('for 2 millionar år sidan', -1998050), ('for 3 milliardar år sidan', -2999998050), ('for 250 millionar år sidan', -249998050)])
