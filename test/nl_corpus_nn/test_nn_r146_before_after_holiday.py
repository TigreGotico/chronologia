# -*- coding: utf-8 -*-
"""R146 (Norwegian Nynorsk) -- see ``test_nl_r146_before_after_holiday.py``
...
"før jul" now binds ``[now, christmas end)`` (mirroring "til jul"), "etter
jul" is refused (no open-ended-future representation). Magnitude forms ("ei
veke før jul") are untouched.
