"""Fuzzy sub-spans (fy): early/mid/late = first/middle/last arithmetic
...
_CASES = [('begjin fan de moanne', 'M', 'early'), ('midden fan de moanne', 'M', 'mid'), ('ein fan de moanne', 'M', 'late'), ('begjin fan it jier', 'Y', 'early'), ('ein fan it jier', 'Y', 'late')]
...
@pytest.mark.parametrize("text", ['begjin', 'betide'])
