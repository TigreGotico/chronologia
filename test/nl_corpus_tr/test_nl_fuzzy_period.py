"""Fuzzy sub-spans (tr): early/mid/late = first/middle/last arithmetic third
of the parent calendar period, marked by a postposed locative noun
(ay sonunda). Parent edges hand-derived; the third is pure timedelta
arithmetic."""
...
_CASES = [("ay başında", "M", "early"), ("ay ortasında", "M", "mid"),
          ("ay sonunda", "M", "late"), ("yıl başında", "Y", "early"),
          ("yıl ortasında", "Y", "mid"), ("yıl sonunda", "Y", "late"),
          ("gelecek ay başında", "NM", "early"), ("gelecek ay sonunda", "NM", "late")]
...
@pytest.mark.parametrize("text", ["baş", "erken"])
