# -*- coding: utf-8 -*-
"""Calendar halves (uk): "first/second half of <year>" splits the year at
...
the Slavic feminine ordinal, the numfold entry that lets "перша" bind NUM=1.
...
_CASES = [
    ('перша половина 2020', 2020, 1, 1, 2020, 7, 1),
    ('друга половина 2020', 2020, 7, 1, 2021, 1, 1),
]
