# -*- coding: utf-8 -*-
"""Confusables corpus for uk -- temporal-looking tokens that must NOT bind.
...
_SPAN_ELSEWHERE = [
    ('маленька деталь через 3 дні', 'деталь'),
    ('мільйон причин через 2 тижні', 'мільйон'),
]
