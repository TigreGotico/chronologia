# -*- coding: utf-8 -*-
"""NL-TDD: "last <weekday> of <month>" binds the last-of-month span (uk).

The "останній" ordinal determiner selects the FINAL occurrence of the named
...
_LAST = [('останній понеділок травня 2017', 2017, 5, 0), ('остання субота серпня 2019', 2019, 8, 5)]
...
def test_low_ordinal_regression():
    ...
    assert start('перший понеділок травня 2017') == AstroDate(2017, 5, 1)
