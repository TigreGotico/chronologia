# -*- coding: utf-8 -*-
"""Fuzzy sub-spans (uk): early/mid/late = first/middle/last arithmetic third of
...
_CASES = [
    ("початок місяця", "M", "early"),
    ("середина місяця", "M", "mid"),
    ("кінець місяця", "M", "late"),
    ("початок року", "Y", "early"),
    ("середина року", "Y", "mid"),
    ("кінець року", "Y", "late"),
    ("початок тижня", "W", "early"),
    ("кінець тижня", "W", "late"),
]
...
@pytest.mark.parametrize("text", ["початок", "зустріч"])
