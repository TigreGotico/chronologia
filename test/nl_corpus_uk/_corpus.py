"""Shared helpers for the Ukrainian natural-language corpus.

The contract under test is the public span-native edge
``extract_timespan(text, "uk", anchor)``: feed a sentence a Ukrainian speaker
...
Ukrainian is a heavily inflected East-Slavic language: the offset unit noun
...
def parse(text, anchor=ANCHOR):
    return extract_timespan(text, "uk", anchor)
