...
Ukrainian names the containing period with the adverbial genitive --
"mynuloho tyzhnia", "tsioho roku" -- or with the locative after "u".
The nominative is the marked register (Ukrainskyi pravopys, 2019).
...
@pytest.mark.parametrize("text,rel,unit", [
    ...
    ('цього місяця', 0, 'month'),
    ('наступного місяця', 1, 'month'),
    ('минулого року', -1, 'year'),
    ('цього року', 0, 'year'),
    ('наступного року', 1, 'year'),
    ('у минулому році', -1, 'year'),
    ('минулий тиждень', -1, 'week'),
])
