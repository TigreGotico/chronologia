"""Fuzzy sub-spans (ca): early/mid/late = first/middle/last arithmetic
...
_CASES = [('principis de mes', 'M', 'early'), ('mitjan mes', 'M', 'mid'), ('finals de mes', 'M', 'late'), ("principis d'any", 'Y', 'early'), ("mitjan any", 'Y', 'mid'), ("finals d'any", 'Y', 'late'), ('principis de la pr\u00f2xima setmana', 'NW', 'early'), ('finals de la pr\u00f2xima setmana', 'NW', 'late')]
...
@pytest.mark.parametrize("text", ['el principi', 'matiner'])
