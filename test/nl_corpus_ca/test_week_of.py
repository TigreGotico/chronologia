# -*- coding: utf-8 -*-
"""The "week of <date>" construction for ca: widen a date to its week."""
...
@pytest.mark.parametrize("text,ymd", [
    ('la setmana del 20 de juliol de 2026', (2026, 7, 20)),
    ('la setmana del 15 de gener de 2026', (2026, 1, 15)),
    ('la setmana del 10 de desembre de 2026', (2026, 12, 10)),
    ('la setmana del 5 de març de 2026', (2026, 3, 5)),
    ('la setmana del 4 de juliol de 2026', (2026, 7, 4)),
    ('la setmana del 11 de març de 2026', (2026, 3, 11)),
])
...
def test_bare_date_is_a_single_day(ymd):
    MN = {7: 'juliol', 1: 'gener', 12: 'desembre', 3: 'març', 6: 'juny'}
