"""Vernacular Roman-calendar anchors (ca) -- Kalends, Nones, Ides.

The three monthly anchors read as ca's own words and compose for free
...
@pytest.mark.parametrize("text,iso", [
    ('els ides de març', '2017-3-15'),
    ("les calendes d'abril", '2017-4-1'),
    ('les nones de juliol', '2017-7-7'),
    ('les nones de gener', '2017-1-5'),
    ('els ides de gener', '2017-1-13'),
    ('les calendes de gener', '2017-1-1'),
])
...
@pytest.mark.parametrize("text,iso", [
    ("3 dies abans de les calendes d'abril", '2017-3-29'),
    ('una setmana abans dels ides de març', '2017-3-8'),
    ("2 dies després de les calendes d'abril", '2017-4-3'),
])
