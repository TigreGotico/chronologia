...
@pytest.mark.parametrize("text,n", [("el primera setmana de juny", 1), ("el segona setmana de juny", 2), ("el tercera setmana de juny", 3)])
...
def test_last_day_of_month():
    assert start("el últim dia de juny") \
        == AstroDate(2017, 6, 30)
...
@pytest.mark.parametrize("text,y,m", [
    ("estiu de 1969", 1969, 6),
    ("hivern de 1970", 1970, 12),
